...
## Usage
### ⚠️ WSL Notice ⚠️
**Mount the container volumes inside WSL's filesystem.** Mounting them inside a filesystem managed by Windows, causes the installation to be painfully slow or even get stuck.
